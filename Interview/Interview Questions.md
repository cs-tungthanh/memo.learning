...
- Tell me about the time when you have to make a difficult decision
- when you came up with the simple solution to a complex problem
-> STAR method
S: situation
Task: Elaborate on the task involved
Action: talk about specific step you took to ensure success
